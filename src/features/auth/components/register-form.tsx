    ...
    <div className="grid gap-6">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="email" className="text-foreground/70 pl-2">邮箱</Label>
            <Input
              id="email"
            ...
            />
            {errors.email && (
              <p className="text-sm text-rose-500 pl-2">{errors.email.message}</p>
            )}
          </div>
          ...
          <div className="grid gap-2">
            <Label htmlFor="confirmPassword" className="text-foreground/70 pl-2">确认密码</Label>
            <Input
              id="confirmPassword"
              type="password"
              placeholder="******"
            ...
            {errors.confirmPassword && (
              <p className="text-sm text-rose-500 pl-2">{errors.confirmPassword.message}</p>
            )}
          </div>
